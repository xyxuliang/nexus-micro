...
import (
	...
	mw "github.com/xyxuliang/nexus-micro/examples/etcd-demo/payment-service/internal/middleware"
	"github.com/xyxuliang/nexus-micro/examples/etcd-demo/payment-service/internal/router"
	"github.com/xyxuliang/nexus-micro/examples/etcd-demo/payment-service/internal/svc"
)

func main() {
	cfg, err := config.Load("etc/payment.yaml")
	if err != nil {
